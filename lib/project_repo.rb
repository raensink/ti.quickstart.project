...
class ProjectRepo
  ...
  def update_git_status
    #
    # Update the state of this object instance to match reality.
    #
    if @dir_name and @dir_path.nil?
    ...
    if @dir_name.nil? and @dir_path.nil?
      # Use the repo name from the url for all future operations.
      # The dir path will remain undefined.
